        ...
        <div className="row mt-3">
          <div className="col-12">
            <div className="alert alert-info">
              Claim transaction pending... TX: <a href={chainConfig.BlockExplorerUrl + claimRequest.data} target="_blank">{claimRequest.data}</a>
            </div>
          </div>
        </div>
        : null}
        ...
        <div className="row mt-3">
          <div className="col-12">
            <div className="alert alert-danger">
              Claim failed. {claimRequest.data as any ? <span>TX: <a href={chainConfig.BlockExplorerUrl + claimRequest.data} target="_blank">{claimRequest.data}</a></span> : null}<br />
        ...
        <div className="row mt-3">
          <div className="col-12">
            <div className="alert alert-success">
              Claim TX: <a className="txhash" href={chainConfig.BlockExplorerUrl + claimRequest.data} target="_blank">{claimRequest.data}</a>
            </div>
          </div>
        </div>
        : null}
